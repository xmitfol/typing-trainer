      ...
      <div class="report-card">
        ...
        <section class="report-block report-metrics">
          ...
          <div class="metric">
            ...
            <div class="metric-val metric-val--sm">${r.attempts || 1}</div>
          </div>
        ...
        <div class="report-actions">
          ${isSuccess
            ? `<button class="btn btn--secondary">↻ Повторить</button>
               <button class="btn btn--lg">Продолжить →</button>`
            : `<button class="btn btn--secondary">Продолжить →</button>
               <button class="btn btn--lg">↻ Повторить</button>`}
        </div>
      </div>
    `;
  }
