...
#### **Tier 1: Free** 🆓
- **Price:** 0₽
- **Content:** Блок 1 (уроки 1-15)
- **Features:**
  - Базовая статистика (WPM, accuracy)
  - Virtual keyboard
  - Weak Keys Analyzer (top 3 клавиши)

**Value Prop:** "Научись основам слепой печати бесплатно"
...
- **Price:** 299₽/месяц
- **Lock:** Цена навсегда для early birds (grandfathered pricing)
- **Duration:** Первые 3 месяца после launch

**Regular:**
- **Price:** 399₽/месяц
- **Start:** После Early Bird периода

**Content:**
- Все уроки (сейчас 30, потом до 99)
- Новые блоки по мере готовности

**Features:**
- ✅ Полный AI Weak Keys Analyzer
- ✅ Speed Plateau Detection (v1.1)
- ✅ Персонализированные рекомендации
- ✅ Детальная статистика + графики
- ✅ История прогресса
...
#### **Tier 3: Premium Annual** 🏆

**Early Bird (первые 100 пользователей):**
- **Price:** 2990₽/год (249₽/месяц)
- **Discount:** -17% vs месячная подписка
- **Lock:** Цена навсегда для early birds

**Regular:**
- **Price:** 3990₽/год (333₽/месяц)
- **Discount:** -17% vs месячная подписка
- **Start:** После Early Bird периода

**Additional Benefits:**
- ✅ Всё из Premium Monthly
- ✅ Приоритетная поддержка (24h response)
- ✅ Ранний доступ к новым фичам (beta testing)
- ✅ Специализированные курсы (future)
...
- ЮКасса (российские карты)

**Payment Flow:**
1. User нажимает "Upgrade to Premium"
2. Выбирает Monthly или Annual
3. Вводит данные карты
4. Подтверждение → instant unlock premium контента
5. Email с подтверждением
...
|------|-------------|----------------|------------|
| Monthly | 333-392₽ | 399₽ (regular) | +7-20% |
| Annual | - | 3990₽ | - |
| Early Bird | - | 299₽/мес | **-10% vs competitor** |
...
- Upgrade prompt:
  > "Продолжи обучение! Уроки 16-99 + AI-коуч ждут тебя.
  > Специальная цена для ранних пользователей: 299₽/месяц (навсегда)"
...
- ✅ MVP: 30 уроков (блоки 1-2)
- ✅ Freemium: 15 free / 84 premium
- ✅ AI: Simplified Weak Keys Analyzer
- ✅ Pricing: 299₽ early / 399₽ regular (monthly)
- ✅ Pricing: 2990₽ early / 3990₽ regular (annual)
- ✅ No Lifetime tier
- ✅ Desktop only
- ✅ Russia first
